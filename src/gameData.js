...
const UI_STRINGS = {
  english: {
    ...
    title: 'Rebuild the sentence by sound.',
    intro:
  ...
  spanish: {
    ...
    title: 'Reconstruye la frase por el sonido.',
    intro:
  ...
  french: {
    ...
    title: 'Reconstruis la phrase par le son.',
    intro:
  ...
  italian: {
    ...
    title: 'Ricostruisci la frase dal suono.',
    intro:
  ...
  german: {
    eyebrow: 'Hör-Puzzle',
    title: 'Baue den Satz über den Klang wieder auf.',
    intro:
  ...
  swedish: {
    ...
    title: 'Bygg upp meningen med hjälp av ljudet.',
    intro:
